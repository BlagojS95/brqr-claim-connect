...
import { Home, FileText, PlusCircle, Bell, Users, LogOut, Shield, FolderArchive, BarChart3, LineChart } from "lucide-react";
...
const items: NavItem[] = [
  ...
  { to: "/visual-graphs", label: "Visual Graphs", icon: LineChart },
